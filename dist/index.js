...
starter.registerHook('messagesCreate', function (_a) {
    var vars = _a.vars, data = _a.data;
    return __awaiter(void 0, void 0, void 0, function () {
        var send;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, axios_1.default.post('https://api.limosms.com/api/sendsms', {
                ...
                case 1:
                    send = _b.sent();
                    return [2 /*return*/, { status: (send.status == 200) }];
            }
        });
    });
});
starter.registerHook('productsCreate', function (data) { return __awaiter(void 0, void 0, void 0, function () {
